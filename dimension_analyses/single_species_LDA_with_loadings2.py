...
# -*- coding: utf-8 -*-
"""
Created on Fri May 31 10:48:59 2024
...
for i in top_feature_indices:
    ...
    ax.quiver(0, 0, 0, vector[0], vector[1], vector[2], color='r', linewidth=1.5)
    # Add labels to the end of each scaled vector
    ax.text(vector[0], vector[1], vector[2], X.columns[i], color='black')
